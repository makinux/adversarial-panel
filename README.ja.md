...
![構成図:ファシリテータがbriefを配布し、異質なパネリストが相互批判して回答と批判を返す](assets/architecture-ja.png)
...
![プロトコル進行図:Round 0 フレーミング → Round 1 独立回答(検証ゲート)→ Round 2 相互批判 → Round 3 最終見解 → 統合](assets/protocol-ja.png)
